...
- [ ] 1. Set up database and model
  - [ ] 1.1 Create backup_schedules migration
  ...
  - [ ] 1.2 Add backup_schedule_id to backup_operations
  ...
  - [ ] 1.3 Create BackupSchedule model
  ...
  - [ ] 1.4 Update BackupOperation model
    - Add `backup_schedule_id` to fillable
    - Add `backupSchedule` relationship
    - _Requirements: 3.2, 4.3_

- [ ] 2. Create schedule service and command
  - [ ] 2.1 Install cron-expression package
  ...
  - [ ] 2.3 Create RunScheduledBackups command
...
- [ ] 3. Create schedule controller and routes
  - [ ] 3.1 Create ScheduleController
...
- [ ] 4. Create frontend pages
  - [ ] 4.1 Create Schedules Index page
  ...
  - [ ] 4.2 Create Schedule Create page
...
- [ ] 5. Add navigation and polish
  - [ ] 5.1 Add Schedules to navigation
    - Update sidebar/navigation to include Schedules link
    - Add calendar/clock icon for schedules
    - _Requirements: 2.1_

  - [ ] 5.2 Add schedule info to backup details
