...
- [x] 1. Database migrations
  - [x] 1.1 Add retention fields to backup_schedules
  ...
  - [x] 1.2 Add protection and deletion fields to backup_operations
...
- [x] 3. Create retention and cleanup services
  - [x] 3.1 Create RetentionService
  ...
  - [x] 3.4 Create GoogleDriveCleanupAdapter
...
- [x] 4. Create cleanup command and scheduler
  - [x] 4.1 Create CleanupBackups command
...
- [x] 5. Add controller endpoints
  ...
  - [x] 5.2 Create SettingsController for retention
  ...
  - [x] 5.3 Add settings routes
    - Add routes for retention settings and cleanup endpoints
    - _Requirements: 1.4, 5.2_

- [x] 6. Update schedule forms with retention
  - [x] 6.1 Update Schedule Create page
...
- [x] 8. Create retention settings page
  ...
  - [x] 8.2 Add Settings to navigation
