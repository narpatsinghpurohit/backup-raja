...
- [ ] 1. Create backend Google Drive service for folder operations
...
- [ ] 2. Create API controller for Google Drive folder operations
...
- [ ] 3. Add API routes for folder operations
...
- [ ] 4. Create folder data type and API service in frontend
...
- [ ] 5. Build FolderTree component for hierarchical folder display
...
- [ ] 6. Build FolderSearchBar component
...
- [ ] 7. Build CreateFolderDialog component
...
- [ ] 8. Build FolderPickerModal component
...
- [ ] 9. Build FolderPickerButton component
...
- [ ] 10. Integrate folder picker into CreateGoogleDrive page
...
- [ ] 11. Integrate folder picker into Edit page for Google Drive connections
