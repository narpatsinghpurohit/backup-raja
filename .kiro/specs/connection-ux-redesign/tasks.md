...
- [ ] 1. Create connection type configuration and shared components
  - [ ] 1.1 Create connection types configuration file
  ...
  - [ ] 1.2 Create TechnologyIcon component
  ...
  - [ ] 1.3 Create TechnologyCard component
...
- [ ] 2. Redesign connection creation flow
  - [ ] 2.1 Create CategoryStep component
  ...
  - [ ] 2.2 Create TechnologyGrid component
  ...
  - [ ] 2.3 Create CredentialForm component
  ...
  - [ ] 2.4 Refactor Create.tsx to use step-based flow
...
- [ ] 3. Enhance connections index page
  ...
  - [ ] 3.2 Update Index.tsx with filtering and icons
  ...
  - [ ] 3.3 Add empty state for filtered results
    - Show message when no connections match filters
    - Include button to clear all filters
    - _Requirements: 3.4_

- [ ] 4. Testing
  - [ ] 4.1 Write unit tests for connection type utilities
  ...
  - [ ] 4.2 Write component tests for create flow
